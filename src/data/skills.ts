...
export const skills: SkillGroup[] = [
  {
    id: 'languages',
    title: { pt: 'Linguagens e Frameworks', en: 'Languages & Frameworks' },
    items: 'PHP 5/7/8, Laravel, Lumen, CakePHP, CodeIgniter, Python, Django.',
  },
  {
    id: 'backend',
    title: { pt: 'Backend e Arquitetura', en: 'Backend & Architecture' },
    items:
  ...
  {
    id: 'integrations',
    title: { pt: 'Integrações e Segurança', en: 'Integrations & Security' },
    items:
  ...
  {
    id: 'messaging',
    title: { pt: 'Mensageria e Processamento Assíncrono', en: 'Messaging & Async Processing' },
    items:
      'RabbitMQ, Redis, Laravel Horizon, AWS SQS, Supervisor, Queue Jobs, Workers, retry, backoff e importação incremental.',
  },
  {
    id: 'quality',
    title: { pt: 'Qualidade e Observabilidade', en: 'Quality & Observability' },
    items:
  ...
  {
    id: 'tools',
    title: { pt: 'Ferramentas e Colaboração', en: 'Tools & Collaboration' },
    items:
